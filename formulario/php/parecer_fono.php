<?php
	...
	$sql = "INSERT INTO `parecer_fon`(`fk_finalidade`, `exa_9_0`, `dexa_9_0`, `crm_9_0`, `tipg_9_1`, `loea_9_1`, 
    ...
    VALUES(:fkfinalidade, :exa, :dexa, :crm, :tipg, :loea, :cb_agl, :prv, :agpv, :ede, :cb_ede0, :cd_ede1, :hip, :cb_hip0,
