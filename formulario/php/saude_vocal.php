<?php
	...
	$sql = "INSERT INTO saude_vocal(`fk_finalidade`, `sinp_6_0`, `cb_sinp_6_1`, `spqt_6_2`, `cfmp_6_2`, `pslc_6_3`, `qnd_6_3`, `cb_pslc_6_4`, `alfa_6_5`, `tfjr_6_6`, `qnd_6_6`, `alfa_6_7`, `etfo_6_8`, `ndse_6_8`, `frse_6_9`, `fdfo_6_9`, `lfea_6_10`, `crvc_6_11`, `qnd_6_11`, `fudm_6_12`, `hqnt_6_12`, `oqmd_6_12`, `freq_6_13`) 
	VALUES (:fkfinalidade, :sinp, :cb_sinp, :spqt, :cfmp, :pslc, :qnd, :cb_pslc, :alfa, :tfjr, :qnd2, :alfa2, :etfo, :ndse, :frse, :fdfo, :lfea, :crvc, :qnd3, :fudm, :hqnt, :oqmd, :freq)";

	$stmt = $PDO->prepare( $sql );
	$stmt->bindParam( ':fkfinalidade', $myvar[22] );
	$stmt->bindParam( ':sinp', $myvar[0] );
	$stmt->bindParam( ':cb_sinp', $myvar[20] );
	$stmt->bindParam( ':spqt', $myvar[1] );
	$stmt->bindParam( ':cfmp', $myvar[2] );
	$stmt->bindParam( ':pslc', $myvar[3] );
	$stmt->bindParam( ':qnd', $myvar[4] );
	$stmt->bindParam( ':cb_pslc', $myvar[21] );
