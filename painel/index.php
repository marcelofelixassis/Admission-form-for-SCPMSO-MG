...
<html>
  			...
  			<div class="col-md-4" style="float: right; margin-top: 10px;">
  				<div class="form-group">
    				<div class="input-group">
        				...
        				<span class="input-group-btn">
        					<button class="btn btn-primary" type="button" onclick="celimjj();">Buscar</button>
      					</span>
    				</div>
  				</div>
  			</div>
  ...
  <script src="./js/scripts_painel/get_primeiros_registros.js"></script>
</html>>
